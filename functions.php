...
if ( ! function_exists( 'resources_setup' ) ) :
	/**
	...
	function resources_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'resources' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'resources_custom_background_args', array(
...
function resources_scripts() {
	wp_enqueue_style( 'resources-style', get_stylesheet_uri() );

	wp_enqueue_script( 'resources-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'resources-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
